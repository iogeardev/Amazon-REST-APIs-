"""Seller Finance extractor (skeleton).
...
def main():
    ...
    rows = [
        "PostedDate":"2026-02-01","EventType":"ShipmentEvent","AmazonOrderId":"902-0000000-0000000","FeeAmount":"-3.21"
    ]

    raw_path = raw_dir / "finance_" + today + ".csv"
    modeled_path = modeled_dir / "fact_finance.csv"
