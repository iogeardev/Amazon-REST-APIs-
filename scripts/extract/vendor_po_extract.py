"""Vendor Purchase Orders extractor (skeleton).
...
def main():
    ...
    rows = [
        "purchaseOrderNumber":"PO123456","purchaseOrderDate":"2026-02-01","status":"Open"
    ]

    raw_path = raw_dir / "purchase_orders_" + today + ".csv"
    modeled_path = modeled_dir / "fact_purchase_orders.csv"
